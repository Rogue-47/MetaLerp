...
- python interface, polished C interface (grouping setters for max and min, and parametric fusing with that too for adva`nced setters)
...
#define META_LERP
    ...
    //initialize the lib simply with this macro at the very beginning of main
